...
// Source: https://github.com/microsoft/vscode/blob/35e0427ee28212f59761e9158008ad4fe73a616d/extensions/git/src/api/git.d.ts
// Synced: 2026-03-10.
...
export interface Repository {
    ...
    // Compatibility with extension-internal usage in this codebase.
...
// Backward-compatible aliases used throughout this extension code.
export type GitRemote = Remote;
export type GitRepository = Repository;
export type GitApi = API;
export type GitExtensionExports = GitExtension;
